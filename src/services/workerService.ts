...
export class WorkerService {
     ...
     * @returns Promise<WorkerProfileModel | null>
     */
    static async createWorkerProfile(profileData: WorkerProfileModel): Promise<WorkerProfileModel | null> {
        try {
            console.log('🚀 Starting worker profile creation...');
            ...
            console.error('❌ Error creating worker profile:');
     ...
     * @returns Promise<WorkerProfileModel | null>
     */
    static async updateWorkerProfile(profileData: WorkerProfileModel): Promise<WorkerProfileModel | null> {
        try {
            ...
            console.error('❌ Error updating worker profile:');
            console.error('Error object:', error);
    ...
    /**
     * Create or update worker profile (legacy method for backward compatibility)
     * @param profileData Worker profile data
     * @returns Promise<WorkerProfileModel | null>
     */
    static async createOrUpdateWorkerProfile(profileData: WorkerProfileModel): Promise<WorkerProfileModel | null> {
        return this.createWorkerProfile(profileData);
    }
}
