...
const Popup: React.FC<PopupProps> = ({ show, onClose, jobTitle, jobPostingId }) => {
    ...
    const fetchResumes = async () => {
        try {
            ...
            console.log('🔄 Popup opened - Calling API: GET https://103.163.24.72/api/worker/profile');
            ...
            if (profile.workerId) {
                console.log(`🔄 Calling API: GET https://103.163.24.72/api/resume/worker/${profile.workerId}`);
    ...
    const handleApply = async () => {
        ...
        try {
            ...
            console.log('🔄 Calling API: POST https://103.163.24.72/api/jobapplication/apply');
