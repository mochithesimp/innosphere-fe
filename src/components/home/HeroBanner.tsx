            ...
            <div className="relative py-12 pb-20">
                ...
                <div className="container relative z-10 mx-auto px-4 max-w-[90%]">
                    ...
                    <div className="flex items-center justify-between py-2 -mt-6 mb-12">
                        ...
                        <div className="flex items-center">
                            <Link to="/" className="flex items-center">
                                <img src="/logo.png" alt="InnoSphere" className="h-8 w-8 mr-2" />
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Link to="/register" className="bg-[#309689] hover:bg-[#277a6e] text-white px-4 py-2 rounded-md transition-colors">
                                Đăng ký
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-8">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Kết Nối Nhanh, Làm Việc Ngay!</h1>
                        <p className="text-gray-300 mb-8">Kết nối nhân lực với cơ hội: Giải pháp cho công việc ngắn hạn.</p>
            ...
            <div className="w-full bg-black py-10">
                <div className="container mx-auto px-4 max-w-[90%]">
                    <div className="flex flex-wrap justify-center md:justify-between items-center gap-8 md:gap-4">
                        {[1, 2, 3, 4, 5].map((num) => (
                            <div key={num} className="w-40 mx-4 md:mx-0 flex items-center justify-center">
                                <img
                                    src={`/hero${num}.png`}
